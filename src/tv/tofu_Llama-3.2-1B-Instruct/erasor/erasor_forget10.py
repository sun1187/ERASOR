...
load_path = "your_path/src/tv/tofu_Llama-3.2-1B-Instruct/tofu_make_rank/pre_weight/forget10_llama3_1b_erasor_ratio90.pt"
...
to_erase_model.save_pretrained('your_path/src/tv/tofu_Llama-3.2-1B-Instruct/erasor/ratio90/'+save_name)
print("SAVE: ", num)