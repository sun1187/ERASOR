...
load_path = "yourpath/src/tv/tofu_Llama-3.1-8B-Instruct/tofu_make_rank/pre_weight/forget01_llama_8b_it_forget_vector.pt"
...
save_name = 'forget01_alpha_'+str(num)

to_erase_model.save_pretrained('yourpath/src/tv/tofu_Llama-3.1-8B-Instruct/original_tv/weight/'+save_name)
print("SAVE: ", num)