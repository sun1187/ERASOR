...
from trainer.unlearn.grad_descent_forget import GradDescent_forget
from trainer.unlearn.grad_descent_retain import GradDescent_retain
...
_register_trainer(GradDescent_forget)
_register_trainer(GradDescent_retain)
